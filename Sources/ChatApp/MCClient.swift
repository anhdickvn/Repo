...
final class MCClient: ObservableObject {
    ...
    func jumpPlayer() {
        ...
        playerY += 1.0
        sendPlayerPosition()
        // Hạ lại nhẹ để server nhận trạng thái giống một cú nhảy ngắn.
    ...
    private func sendPlayerPosition() {
        ...
        payload.append(1) // onGround
        send(packetId: 0x0D, payload: payload) // Player Position serverbound, protocol 340
    }
